...
from backend.models import Category, Brand, Product, User, CartItem
from rest_framework import status
from unittest.mock import patch
from collections import OrderedDict
from backend.tests.fixtures_test import create_product, create_cart, create_cartItem, create_brand, create_user, create_category
from backend.views_folder.cart_views import CartAPI
