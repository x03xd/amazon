...
from backend.views_folder import views
from backend.views_folder import auth_views
from backend.views_folder import rate_views
from backend.views_folder import edit_user_views
from backend.views_folder import cart_views
from backend.views_folder import currencies_views
from backend.views_folder import transactions_views
from backend.views_folder import filter_products_views
from backend.views_folder import opinions_views
from backend.views_folder import payments_views

from backend.views_folder.auth_views import MyTokenObtainPairView
